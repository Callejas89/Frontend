...
function pintarRespuestaBike(response){
    ...
    myTable+="</table>";
    $("#ListaBike").html(myTable);
}

function cargarDatosBike(id) {
    $.ajax({
        dataType: 'json',
        url:"http://129.151.108.112:8081/api/Bike/"+id,
    ...
    if($("#name2").val().length == 0 || $("#brand").val().length == 0 || $("#year").val().length == 0 || $("#description2").val().length == 0){
       alert("Todos los campos son obligatorios")
            ...
            $.ajax({
                ...
                url:"http://168.138.247.22:80/api/Bike/save",
    ...
    $.ajax(
        {
            dataType: 'json',
            data: dataToSend,
            url:"http://129.151.108.112:8081/api/Bike/"+idElemento,
...
function actualizar(idElemento) {
    ...
    if($("#name2").val().length == 0 || $("#brand").val().length == 0 || $("#year").val().length == 0 || $("#description2").val().length == 0){
        ...
        $.ajax({
            ...
            data: dataToSend,
            contentType: "application/JSON",
            url:"http://129.151.108.112:8081/api/Bike/update",
