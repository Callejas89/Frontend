function traerInformacionCategoria(){
    console.log("test");
        $.ajax({
        url:"http://129.151.108.112:8081/api/Category/all",
        type:"GET",
        datatype:"JSON",
...
function guardarInformacionCategoria(){
    ...
    if ($("#Categoryname").val().length==0 || $("#Categorydescription").val().length==0){
    ...
    let var2 = {
        ...
        url:"http://129.151.108.112:8081/api/Category/save",
       
        
        success:function(response) {
                console.log(response);
            console.log("Se guardo correctamente");
            alert("Se guardo correctamente la nueva categoria");
...
function actualizarInformacionCategoria(idElemento){
    ...
    $.ajax({
        url:"http://129.151.108.112:8081/api/Category/update",
        type:"PUT",
        data:dataToSend,
...
function borrarCategoria(idElemento){
    ...
    $.ajax({
        url:"http://129.151.108.112:8081/api/Category/"+idElemento,
        type:"DELETE",
        data:dataToSend,
        contentType:"application/JSON",
        datatype:"JSON",
